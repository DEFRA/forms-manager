...
import {
  getExpectedTimelineMetrics1,
  getExpectedTimelineMetrics2
...
describe('report-timeline', () => {
  describe('generateReportTimeline', () => {
    ...
    it('should gather metrics for all forms, for 7th May 2025', async () => {
      const allMetadata = [
      ...
      expect(metrics).toEqual(getExpectedTimelineMetrics1())
    })

    it('should gather metrics for all forms, for 8th August 2025', async () => {
      const allMetadata = [
        buildMetadataDocument({
          title: 'Form 1 title',
          slug: 'form-1-title',
      ...
      const metrics = await generateReportTimeline(new Date(2025, 7, 8))

      expect(metrics).toEqual(getExpectedTimelineMetrics2())
    })
