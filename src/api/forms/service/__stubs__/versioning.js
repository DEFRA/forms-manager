...
/**
 *
 * @param {Partial<FormVersionDocument>} partialFormVersion
 * @returns {FormVersionDocument}
 */
export function buildFormVersionDocument(partialFormVersion = {}) {
  return {
    _id: new ObjectId(),
 ...
 */
export const mockFormVersionDocument = buildFormVersionDocument()
/**
